...
public class ReturnVO {
	...
	public ReturnVO(String memberSignToken, String projectTempToken, Integer type, Integer supportmoney, String content, Integer count, Integer signalpurchase, Integer purchase, Integer freight, Integer invoice, Integer returndate, String describPicPath) {
		this.memberSignToken = memberSignToken;
		this.projectTempToken = projectTempToken;
		this.type = type;
		this.supportmoney = supportmoney;
